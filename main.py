...
#TODO: implement scheduling stuff (wiki), add command: list observed/manual pages, schedules owner only machen oder dafür sorgen dass andere nicht meine schedules sehen oder löschen können, manuelle pages warning nur wenn neues level kam
